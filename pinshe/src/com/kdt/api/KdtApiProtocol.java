...
public class KdtApiProtocol {
    ...
    public static String sign(String appSecret, HashMap<String,String> parames) throws UnsupportedEncodingException{
    ...
    private static String hash(String signContent) throws UnsupportedEncodingException{
    	String hashResult = "";
		try {
