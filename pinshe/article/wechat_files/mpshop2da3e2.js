...
return n;
});define("a/mpshop.js",["biz_common/dom/event.js","biz_common/utils/report.js","appmsg/a_report.js","biz_wap/utils/ajax.js","biz_wap/utils/position.js","biz_wap/jsapi/core.js","biz_common/utils/url/parse.js"],function(o){
"use strict";
function t(o,t){
r("http://mp.weixin.qq.com/mp/ad_report?action=follow&type="+o+t.report_param);
}
function i(o){
var i=o.adData,r=o.pos_type||0,e=i.tid,_=i.type,m=(i.adid,i.outer_id),c=i.url,l=i.rl,j={};
o.report_param=o.report_param||"";
var u=o.btn;
if(u){
p.on(u,"click",function(i){
if(!j[e]){
j[e]=!0;
var p,u,d=!!i&&i.target;
d&&(p=a.getX(d,"js_ad_link extra_link")+i.offsetX,u=a.getY(d,"js_ad_link extra_link")+i.offsetY),
s({
type:_,
report_type:2,
click_pos:0,
...
j[e]=!1,t(61,o),location.href=n.join(c,{
outer_id:m
});
});
}
...
var p=o("biz_common/dom/event.js"),r=o("biz_common/utils/report.js"),e=o("appmsg/a_report.js"),s=e.AdClickReport,a=(o("biz_wap/utils/ajax.js"),
o("biz_wap/utils/position.js")),n=(o("biz_wap/jsapi/core.js"),o("biz_common/utils/url/parse.js"));
return i;
});